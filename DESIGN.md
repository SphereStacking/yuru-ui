...
今は実装しない。`data-theme` の値を文字列で自由に受けられる設計なので、あとから追加できる。

- **とげ（toge）** — 角丸ゼロ、シャープなシャドウ、直線的。ダーク系と相性よさそう
- **もこ（moko）** — ほよよりさらにもこもこ。角丸めちゃ大きい、blob的な形、雲みたいな
- **きら（kira）** — グラデーション多め、光沢感、ちょっとリッチ
- **ねむ（nemu）** — 低コントラスト、淡い色、シャドウ薄め。目に優しい夜向け
